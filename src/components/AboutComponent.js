...
function RenderPartner({partner}) {
    if (partner) {
        return(
            <React.Fragment>
                <Media src={baseUrl + partner.image} alt={partner.name} width="150" object="true" />
                <Media body="true" className="ml-5 mb-4" ><Media heading="true">{partner.name}</Media>{partner.description}</Media>
            </React.Fragment>
        )
    }else{
        <div></div>
